    ...
    <Card className="bg-gradient-to-r from-brand-gold/10 to-brand-primary/10 border-brand-gold/20">
      <CardContent className="p-4 space-y-3">
        ...
        <Button
          ...
          variant="outline"
          className="w-full bg-white border-green-600 text-green-600 hover:bg-green-50"
        >
  ...
  return (
    <div className="bg-surface-primary">
      <div className="py-4 space-y-6">
        ...
        {/* Referral Link + How It Works - side by side on desktop */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
          {/* Left: Referral Link (includes WhatsApp button) */}
          {referralLink && (
            <ReferralLinkCard
